# Orchestra Angular Coding Style Guide
This style guide is a fork of [John Papa's Angular Style Guide](https://github.com/johnpapa/angular-styleguide/blob/master/README.md)    
  
Consequently, the vast majority of this guide is written for JavaScript, but you should be able to understand most of the concepts and apply them to TypeScript very easily.  
Some of the more advanced concept have been converted to TypeScript. 
   
Feel free to write a TypeScript sample instead of the JavaScript default one if you deem it fit.
...
### Warning  
  ...
  Closures are JavaScript's way of defining private members and allow encapsulation. TypeScript handle this problem differently throught module and classes. You should wrap angular components in a class, not in an IIFE, except when initially registering an angular module, or a directive. 


  ```typescript
    module vnext.login.authentication {

      ((): void => {
        'use strict';

        angular.module('vnext.login.authentication', []);
...
###### [Style [Y212](#style-y212)]
  ...
  - Use [animate.css](http://daneden.github.io/animate.css/) for conventional animations.
    ...
    *Why?*: animate.css is widely used and tested.
    ...
    Note: See this [great post by Matias NiemelÃ¤ on Angular animations](http://www.yearofmoo.com/2013/08/remastered-animation-in-angularjs-1-2.html)
...
_Other Style Guides_  
* [AngularJS Style Guide](https://github.com/johnpapa/angularjs-styleguide)
* [JavaScript ES6 Style Guide](https://github.com/elierotenberg/coding-styles/blob/master/es6.md)
* [TypeScript Style Guide](https://github.com/Platypi/style_typescript)
...
_Design_  
https://style.codeforamerica.org/  
http://patternlab.io/